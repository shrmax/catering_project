...
$query= 'SELECT o.order_id, o.order_date,o.number_ppl,o.address,o.alternative_phone_no,o.event_date,o.time,o.request,o.veg_ids,o.non_veg_ids,o.desert_ids,o.juice_ids,o.grand_total,o.status,s.name,s.phone_no,s.email,p.id,p.name,p.image,p.phone_no,e.name,e.image from orders o JOIN signup s on s.usr_id=o.user_id JOIN providers p on p.id=o.provider_id JOIN events e on e.id=o.event_id where p.id='.$_SESSION['providerid'].' and o.order_id='.$_POST['details'].';';
$result = mysqli_query($con, $query);
while($row=mysqli_fetch_array($result,MYSQLI_NUM)){
?>  
<div class="orderinfo">
    <img src="../admin/eventimages/<?php echo $row[22]?>" alt="" width="700px" height="400px">
    <div class="details">
    <div class="eves">
    ...
    <p id="event"><?php echo $row[21] ?></p>   
                ...
                <p id="amont">Adress :<span><?php echo $row[3] ?></span></p>
                ...
                <form action="include/statusupdate.php" method="post">
                  <button type="submit" name="reject" value="<?php echo $row[0] ?>">Reject</button>
                </form>
                <?php }
                ?>
            </div>
